...
@pytest.mark.parametrize("figsize", [(800, 300), (400, 400)])
@pytest.mark.parametrize("font_scale", [0.5, 1.0, 2.0])
@pytest.mark.parametrize("highlight_atoms", [True, False])
...
def test_examine_normal_mode(xyz, disp, rsmi, psmi):
    ...
    assert examine_normal_mode(rmol, pmol, xyz, disp, verbose=False, as_factors=False)
...
def test_is_valid_habs_ts(xyz, disp, rsmi, psmi):
    ...
    assert is_valid_habs_ts(rmol, pmol, xyz, disp)
