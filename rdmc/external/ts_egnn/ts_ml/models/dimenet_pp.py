...
class EmbeddingBlock(torch.nn.Module):
    def __init__(self, node_dim, num_radial, hidden_channels, act=swish):
        super(EmbeddingBlock, self).__init__()
        self.act = act

        self.emb = Linear(node_dim, hidden_channels)
...
class DimeNetPlusPlus(torch.nn.Module):
    ...
    def __init__(
        ...
        self.emb = EmbeddingBlock(node_dim, num_radial, hidden_channels, act)
    ...
    def forward(self, x, z, pos, edge_index, batch=None, mask=None):
        ...
        out = scatter(P, batch, dim=0, reduce="add")
